...
lib.dialog('getServiceInformation', [
    function(session, args){
        ...
        if(customerAnalyticsEntity){
            ...
            builder.Prompts.choice(session, "Wähle einen Bereich aus, um mehr Informationen zu erhalten", "Customer Analytics|Industry Analytics|IT Operations Analytics|Financial Analytics|Technology", {listStyle: builder.ListStyle.button}); 
        }
    },
